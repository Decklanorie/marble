...
var fwidth = (BuildContext context)=>MediaQuery.of(context).size.width;
var fheight = (BuildContext context)=>MediaQuery.of(context).size.height;
const testSpace = SizedBox(width: 8,);
var addVerticalSpace = (double space)=> SizedBox(height: space);
var addHorizontalSpace = (double space)=> SizedBox(width: space,);
