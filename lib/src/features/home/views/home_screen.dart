  ...
  Widget build(BuildContext context) {
    ...
    child:SafeArea(
      child: Stack(children:[
        ...
        if(showBS) TweenAnimationBuilder<double>(
          tween: Tween<double>(begin: 0.0, end: _isInitialAnimationDone ? (fheight(context)-450.h)/fheight(context) : 0.0),
          duration: Duration(milliseconds: 800),
          ...
          builder: (context, value, child) {
            return DraggableScrollableSheet(
              ...
              minChildSize: value,
              maxChildSize:(fheight(context)*.75)>650?(.7):((fheight(context)*.75)/(fheight(context))),
